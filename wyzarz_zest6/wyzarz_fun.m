...
for cyk=1:liczba_cykli
  x = (0.5*T*(2*rand-1));
   ...
   E = fun9(Rozw2(1),Rozw2(2));        % wartosc funkcji 
   ...
   if T<Tmin 
      T=Tmin;                          % nowa wartosc temperatury
   end
end
...
plot(Droga(end,1)',Droga(end,2)','gs'); % rozw. optymalne zaznaczone zielonym kwadratem
...
wartosc_koncowa = fun9(Rozwmin(1),Rozwmin(2))